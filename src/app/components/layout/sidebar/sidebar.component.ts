...
export class SidebarComponent implements OnInit, OnDestroy, OnChanges {
  ...
  private updateRouteTitle(): void {
    ...
    // Update menu items based on current route
    ...
    switch (true) {
      ...
      case routePath.includes('/products'):
        ...
        break;
      case routePath.includes('/publication-category'):
        this.currentRouteTitle = 'Categorías de Publicaciones';
        break;
      case routePath.includes('/publications'):
        this.currentRouteTitle = 'Publicaciones';
        break;
      default:
